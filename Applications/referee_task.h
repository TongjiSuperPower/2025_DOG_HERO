...
{
	uint16_t chassis_voltage;//已经删了，保留位
	uint16_t chassis_current;//已经删了，保留位
	float chassis_power;//已经删了，保留位
...
typedef __packed struct  //0x0204
{
	...
	uint8_t remaining_energy;//bit 0-4：机器人剩余能量值反馈，以16进制标识机器人剩余能量值比例，仅在机器人剩余能量小于50%时反馈，其余默认反馈0x32。 
	/*
	bit 0：在剩余能量≥50%时为1，其余情况为0 
	bit 1：在剩余能量≥30%时为1，其余情况为0
	bit 2：在剩余能量≥15%时为1，其余情况为0 
	bit 3：在剩余能量≥5%时为1，其余情况为0
	Bit4：在剩余能量≥1%时为1，其余情况为0 
	*/
